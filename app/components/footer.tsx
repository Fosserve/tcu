...
import imagesvg from "../../public/wavesOpacity (5).svg"
import logo from "../../public/logo1.png"

const navigation = {
    About: [
      { name: 'Economic Importance', href: '/Economic' },
      { name: 'Social Impact', href: 'social' },
      { name: 'Addressing Challenges', href: '#' },
      { name: 'Cultural Significance', href: '#' },
      { name: 'Financial Impact', href: '#' },
    ],
    support: [
